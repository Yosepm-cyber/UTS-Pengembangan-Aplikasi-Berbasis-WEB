...
<head>
	...
	<title>Guru | Absensi Siswa</title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<img src="../assets/img/LOGO SMK.png" alt="navbar brand" class="navbar-brand" width="40">
					<b class="text-white">SMK YAPAN</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa SMK YAPAN SUKABUMI (<a href="index.php">Yosep Maulana Official </a> | 2021)
					</div>				
				</div>
			</footer>
		</div>
